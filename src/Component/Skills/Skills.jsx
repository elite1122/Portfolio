...
const Skills = () => {
  return (
    <motion.div
      ...
      className="flex gap-10 lg:gap-20 mx-auto px-6"
    >
      <div className="w-full">
        <div className="py-12 font-titleFont flex flex-col gap-4 text-white">
          <h2 className="text-3xl md:text-4xl font-bold">Skills</h2>
        </div>
        <div className='className="mt-14 w-full flex flex-col gap-6 text-white'>
